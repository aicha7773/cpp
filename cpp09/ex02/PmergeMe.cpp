...
/*   Updated: 2024/01/22 01:35:21 by aatki            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::list<int> mergesortList(std::list<int> lst)
{
    ...
    if (lst.size() == 1)
        return lst;
    if(lst.size() % 2 == 0)
        lstOne.assign(lst.begin(), std::next(lst.begin(), lst.size() / 2));
    else
        lstOne.assign(lst.begin(),std::next(lst.begin(), lst.size() / 2 - 1));
    lstTwo.assign(std::next(lst.begin(), lst.size() / 2), lst.end());
